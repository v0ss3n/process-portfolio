...
It's never fully clear to the audience what is the input for what output. Instead, the viewer remains captivated to see if the ink can go around the corner to reach the canvas. What is left after every performance is a visual representation of the event.
